...
public class BatteryMeterView extends LinearLayout implements DarkReceiver {
    ...
    public BatteryMeterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final MarginLayoutParams mlp = new MarginLayoutParams(
                getBatteryStyle() == BATTERY_STYLE_PORTRAIT ? getResources().getDimensionPixelSize(R.dimen.status_bar_battery_icon_width)
    ...
    void scaleBatteryMeterViews() {
        ...
        LinearLayout.LayoutParams scaledLayoutParams = new LinearLayout.LayoutParams(
                Math.round(getBatteryStyle() == BATTERY_STYLE_PORTRAIT  ? fullBatteryIconWidth : fullBatteryIconHeight),
